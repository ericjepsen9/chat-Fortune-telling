...
function buildPrompt(mode, displayMode, question) {
  ...
  const fullInstructions = {
    bazi: `用户没有输入具体问题，请进行【一生命运全面分析】，结构如下：

一、【八字排盘概述】（3句）
简述四柱组合特点、日主强弱、格局类型、用神忌神。

二、【性格与天赋】（6句）
基于日主五行特征分析核心性格，结合时支性格数据分析深层特质。分析金水/木火/土等五行旺衰对性格的影响。指出天赋才华和性格盲点。

三、【大运一生总览】（这是最重要的部分，每步大运3-4句）
逐步分析数据中每步大运，结合大运标签（少年运/青年运/起步运/上升运/稳定运/享福运/安康运/长寿运）和吉凶判断，详细描述：
- 该阶段的人生主题
- 事业/财运趋势
- 感情/家庭变化
- 每个阶段结尾给出总评

按人生阶段分段：少年期、青年期、中年期、晚年期，每段有小标题。

四、【事业财运】（5句）
适合什么行业、不适合什么、财运是正财为主还是偏财、什么年龄段财运最旺、理财忠告。

五、【婚姻家庭】（5句）
恋爱特点、适合什么类型伴侣、婚姻宫特征、最佳婚恋年龄段、子女缘、家庭和谐度。

六、【健康注意】（3句）
基于健康提示数据，分析五行旺衰对应的身体风险，指出需要注意的器官和凶月/吉月。

七、【关键流年预测】（每年1-2句）
基于十年运程概览数据，对未来几年逐年预测运势走向，标注吉凶。

八、【一句话总命运】
用一段话（3-4句）高度概括此人的一生命运走向，先苦后甜/一路顺遂/波折起伏等定性。

总字数2000-3000字。内容要具体、有时间节点、不说空话套话。每个判断都要引用数据中的具体干支作为依据。`,
